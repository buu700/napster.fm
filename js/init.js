...
if (window.location.pathname == '/' && window.languageCodes && language) {
	window.languageCodes.forEach(function (languageCode) {
		if (language.has(languageCode) || languageCode.has(language)) {
			window.location.pathname	= '/' + languageCode + '.html';
		}
	});
}
